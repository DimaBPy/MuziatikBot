...
async def changelog(callback_query: CallbackQuery):
    await callback_query.message.edit_text(
        ...
        "2.7: Упрощён кубик.\n"
        "3.0 beta: База данных, разные версии (beta/стабильная)\n"
        "3.0: Всё допилено, добавлены ID для отзывов/вопросов\n"
        "3.1: Добавлена смена раскладки\n"
        "3.2: Текущая версия: Улучшена стабильность."
    )
